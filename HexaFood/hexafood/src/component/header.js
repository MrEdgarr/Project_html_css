    ...
    return (
        <>
            ...
            <header className="header">
                <div className={`topbar ${isWidth <= 992 || scrollPosition >= 300 ? 'fixed-top' : ''}`}>
